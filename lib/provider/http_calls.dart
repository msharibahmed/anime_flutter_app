...
import 'package:anime_flutter_app/model/episode_links_model.dart';
import 'package:anime_flutter_app/model/search_details_model.dart';
...
class HttpCalls with ChangeNotifier {
  ...
  Future<void> showEpisodelinks(String episodeEndPoint) async {
    final url =
        'https://anime-rest-api.herokuapp.com/episode/$episodeEndPoint' as Uri;
    print(url);
  ...
  Future<void> showLatestRelease(int page) async {
    final url = 'https://anime-rest-api.herokuapp.com/home/$page' as Uri;
    print('function executed');
    try {
      final response = await http.get(url);
  ...
  Future<void> showSearchDetails(String link) async {
    final url =
        'https://anime-rest-api.herokuapp.com/searchdetails/$link' as Uri;
  ...
  Future<void> showSearchResult(String search) async {
    final url = 'https://anime-rest-api.herokuapp.com/search/$search' as Uri;
